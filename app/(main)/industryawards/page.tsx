...
export default async function Page() {
    ...
    if (res.ok) {
        ...
        industryawards = data.industryawards;
    }

    return mobileCheck ? <MobIndustryInfo contents={industryawards} nameA="Industry" nameB=" Awards" address="industryawards"/> : <IndustryInfo contents={industryawards} nameA="Industry" nameB=" Awards" address="industryawards"/>;
}
