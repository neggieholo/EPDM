...
import NavbarDropdown from '../LandingpageComponents/NavBarDropdown';
...
export default function DummyNavbar({ zIndex = 0, disabled = true }: NavbarProps) {
    ...
    return (
        <nav
            className={`w-full h-fit bg-primary text-white shadow-md flex justify-center items-center
                  ${disabled ? "pointer-events-none" : ""}`}
            style={{ zIndex }}
        >
            <div className="absolute left-0 top-0 flex items-center p-2 w-[15%]">
                <Image
                    src="/epdm_logo.png"
                    alt="EPDM Logo"
