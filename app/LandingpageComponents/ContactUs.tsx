...
const ContactUs: React.FC<ContactUsProps> = ({ contact }) => {
    ...
    return (
        <section className="w-full h-screen flex flex-col items-center justify-center bg-white pt-48">
            <div className="max-w-3xl mx-auto bg-accent/50 shadow-md rounded-lg border border-gray-200 p-6">
                {/* Page Header */}
