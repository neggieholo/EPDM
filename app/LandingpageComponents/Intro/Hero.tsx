...
import DummyNavbar from "@/app/utils/DummyNavbar";
...
export default function HeroSection() {
    ...
    return (
        <>        
            <DummyNavbar />
            <section
                className="relative h-[70vh] flex items-center justify-center text-center text-white overflow-y-auto p-4"
                style={{
                ...
                {/* Centered content */}
                <div className="z-10 p-4 justify-center flex-col items-center w-[80%] grid grid-cols-2 grid-rows-2 h-[70%]">
                    <div className="bg-white/50 flex flex-col items-center justify-center px-1 py-4">
