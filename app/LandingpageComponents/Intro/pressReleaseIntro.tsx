...
// 👇 This component is now Server-Side Rendered
export default async function NewsIntro() {
    ...
    try {
        ...
        news = Array.isArray(data.news) ? data.news.slice(0, 4) : [];
    } catch (err) {
        ...
        <section className="w-full bg-white py-16 flex flex-col items-center text-white">
            ...
            <div className="w-[70%] text-center mb-10 text-primary">
                ...
                <p className="text-lg text-accent">
                    Get a quick look at our most recent announcements, company updates,
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-300 line-clamp-3">
                                    {textSection?.content ||
                                        "Click below to learn more about our recent updates."}
                                </p>
                            </div>
                        );
                    })
