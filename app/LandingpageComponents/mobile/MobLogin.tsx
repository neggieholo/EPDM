...
import resendVerificationMail from "@/app/utils/LandingPageFetchers";
import { verifyEmailToken } from "@/app/utils/SignUpFetchers";



const MobLoginCard: React.FC = () => {
    ...
    return (
        <section className="w-full min-h-screen flex items-center justify-center bg-white py-20">
            <div className="w-[90%] bg-accent/50 p-8 border border-accent/20">
