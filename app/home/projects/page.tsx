...
import { fieldMappings, filterEmptyValues } from "@/app/utils/ProjectFetchers";
...
export default async function Page() {
    ...
    return mobileCheck
        ? <MobProjectsPage projects={projectData.projects || []} subscription={projectData.subscription} returnPage="All Projects" />
        : <ProjectsPage projects={projectData.projects || []} subscription={projectData.subscription} returnPage="All Projects" />;
}
